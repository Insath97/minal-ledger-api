...
class PermissionController extends Controller implements HasMiddleware
{
    ...
    {
        try {
            $this->logActivity('INDEX', 'Permission', 'Viewed permission list');
            ...
            $query->orderBy('id', 'asc')->orderBy('name', 'asc');
    ...
    public function show(string $id)
    {
        try {
            ...
            $this->logActivity('SHOW', 'Permission', "Viewed permission: {$permission->name}");
    ...
    public function destroy(string $id)
    {
        try {
            ...
            $permission->delete();
            $this->logActivity('DELETE', 'Permission', "Deleted permission: {$permName}");
